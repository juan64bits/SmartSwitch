...
void htmlPageConfig() 
{
  if(serverBegan) 
  {
		...
		rootPage.replace("DEVICE_NAME",deviceName); //Moved to finish ( replace variables feature )      
		...
		rootPage.replace("MQTT_USERNAME",mqttUsername); //Moved to finish ( replace variables feature )
